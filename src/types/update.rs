...
impl RObject for Update {
  ...
  fn extra(&self) -> Option<&str> {
    match self {
      ...
      Update::ProfileAccentColors(t) => t.extra(),
      ...
      Update::DefaultBackground(t) => t.extra(),
      ...
      Update::SpeechRecognitionTrial(t) => t.extra(),
  ...
  fn client_id(&self) -> Option<i32> {
    match self {
      ...
      Update::ProfileAccentColors(t) => t.client_id(),
      ...
      Update::DefaultBackground(t) => t.client_id(),
      ...
      Update::SpeechRecognitionTrial(t) => t.client_id(),
...
/// The list of supported profile accent colors has changed
...
impl RObject for UpdateProfileAccentColors {
  #[doc(hidden)]
  fn extra(&self) -> Option<&str> {
    self.extra.as_deref()
  }
...
impl TDUpdate for UpdateProfileAccentColors {}

impl UpdateProfileAccentColors {
  pub fn from_json<S: AsRef<str>>(json: S) -> Result<Self> {
    Ok(serde_json::from_str(json.as_ref())?)
  }
  pub fn builder() -> UpdateProfileAccentColorsBuilder {
    let mut inner = UpdateProfileAccentColors::default();
    inner.extra = Some(Uuid::new_v4().to_string());

    UpdateProfileAccentColorsBuilder { inner }
  }
}

#[doc(hidden)]
pub struct UpdateProfileAccentColorsBuilder {
  inner: UpdateProfileAccentColors,
}

#[deprecated]
pub type RTDUpdateProfileAccentColorsBuilder = UpdateProfileAccentColorsBuilder;

impl UpdateProfileAccentColorsBuilder {
  pub fn build(&self) -> UpdateProfileAccentColors {
    self.inner.clone()
  }
}

impl AsRef<UpdateProfileAccentColors> for UpdateProfileAccentColors {
  fn as_ref(&self) -> &UpdateProfileAccentColors {
    self
  }
}

impl AsRef<UpdateProfileAccentColors> for UpdateProfileAccentColorsBuilder {
  fn as_ref(&self) -> &UpdateProfileAccentColors {
    &self.inner
  }
}
...
impl UpdateAccentColorsBuilder {
  ...
  pub fn available_accent_color_ids(&mut self, available_accent_color_ids: Vec<i32>) -> &mut Self {
...
/// The default background was changed
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
impl RObject for UpdateDefaultBackground {
  #[doc(hidden)]
  fn extra(&self) -> Option<&str> {
    self.extra.as_deref()
  }
...
impl TDUpdate for UpdateDefaultBackground {}

impl UpdateDefaultBackground {
  pub fn from_json<S: AsRef<str>>(json: S) -> Result<Self> {
    Ok(serde_json::from_str(json.as_ref())?)
  }
  pub fn builder() -> UpdateDefaultBackgroundBuilder {
    let mut inner = UpdateDefaultBackground::default();
    inner.extra = Some(Uuid::new_v4().to_string());

    UpdateDefaultBackgroundBuilder { inner }
  }
...
#[doc(hidden)]
pub struct UpdateDefaultBackgroundBuilder {
  inner: UpdateDefaultBackground,
}

#[deprecated]
pub type RTDUpdateDefaultBackgroundBuilder = UpdateDefaultBackgroundBuilder;

impl UpdateDefaultBackgroundBuilder {
  pub fn build(&self) -> UpdateDefaultBackground {
    self.inner.clone()
  }
...
impl AsRef<UpdateDefaultBackground> for UpdateDefaultBackground {
  fn as_ref(&self) -> &UpdateDefaultBackground {
    self
  }
}

impl AsRef<UpdateDefaultBackground> for UpdateDefaultBackgroundBuilder {
  fn as_ref(&self) -> &UpdateDefaultBackground {
    &self.inner
  }
}
...
impl RObject for UpdateSpeechRecognitionTrial {
  #[doc(hidden)]
  fn extra(&self) -> Option<&str> {
    self.extra.as_deref()
  }
...
impl TDUpdate for UpdateSpeechRecognitionTrial {}

impl UpdateSpeechRecognitionTrial {
  pub fn from_json<S: AsRef<str>>(json: S) -> Result<Self> {
    Ok(serde_json::from_str(json.as_ref())?)
  }
  pub fn builder() -> UpdateSpeechRecognitionTrialBuilder {
    let mut inner = UpdateSpeechRecognitionTrial::default();
    inner.extra = Some(Uuid::new_v4().to_string());

    UpdateSpeechRecognitionTrialBuilder { inner }
  }
}
#[doc(hidden)]
pub struct UpdateSpeechRecognitionTrialBuilder {
  inner: UpdateSpeechRecognitionTrial,
}

#[deprecated]
pub type RTDUpdateSpeechRecognitionTrialBuilder = UpdateSpeechRecognitionTrialBuilder;

impl UpdateSpeechRecognitionTrialBuilder {
  pub fn build(&self) -> UpdateSpeechRecognitionTrial {
    self.inner.clone()
  }
}

impl AsRef<UpdateSpeechRecognitionTrial> for UpdateSpeechRecognitionTrial {
  fn as_ref(&self) -> &UpdateSpeechRecognitionTrial {
    self
  }
}

impl AsRef<UpdateSpeechRecognitionTrial> for UpdateSpeechRecognitionTrialBuilder {
  fn as_ref(&self) -> &UpdateSpeechRecognitionTrial {
    &self.inner
  }
}
